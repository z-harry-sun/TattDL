...
class tattc_voc(datasets.imdb):
    def __init__(self, image_set, year, devkit_path=None):
        print('[tattic_voc init]')
        print(image_set)

        datasets.imdb.__init__(self, 'tattc_voc_' + year)
        ...
        self._classes = ('__background__', # always index 0, total 22
    ...
    def selective_search_roidb(self):
        ...
        if self._year == "032816" or self._image_set != 'test':
            print('[gt_roidb, ss_roidb]')
    ...
    def _load_tattc_annotation(self, index):
        """
        Load image and bounding boxes info from XML file in the TATTC VOC
        format.
        """
    ...
    def _write_voc_results_file(self, all_boxes):
        ...
        path = os.path.join(self._devkit_path, 'results', 'tattc_voc' + self._year,
                            'Main', comp_id + '_')
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} tattc_voc results file'.format(cls)
...
if __name__ == '__main__':
    d = datasets.tattc_voc('tattc_voc', '032816')
    res = d.roidb
